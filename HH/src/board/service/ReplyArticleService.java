...
import board.model.ReplyingRequest;
...
public class ReplyArticleService {
	...
	private void checkParent(Article parent,int parentId) throws ArticleNotFoundException,CannotReplyArticleException {
		if(parent == null) {
			throw new ArticleNotFoundException("부모글이 존재하지않음 : " +parentId);
		}
	...
	private String getSearchMinSeqNum(Article parent) {
		String perentSeqNum = parent.getSequenceNumber();
		DecimalFormat decimalFormat = new DecimalFormat("0000000000000000");
		long parentSeqLongValue=Long.parseLong(perentSeqNum);
		...
		case 0:
			...
			break;
		case 1:
			searchMinLongValue = parentSeqLongValue/1000L*1000L;
			break;
		case 2:
